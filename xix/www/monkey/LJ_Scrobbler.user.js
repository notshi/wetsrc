...
//
// version 2007-01-10
// Fixed the location of recent played track and the screen scraping for deafault username
//
...
if(audioscrobbler_username=='*')
{
	...
	if (current_username)
	{
			audioscrobbler_username=current_username.textContent;
	}
...
GM_xmlhttpRequest({
    method: 'GET',
    url: 'http://ws.audioscrobbler.com/1.0/user/' + audioscrobbler_username + '/recenttracks.rss' , 
    headers: {
